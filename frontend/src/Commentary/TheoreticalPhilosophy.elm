...
The _Theoretical Part_ of the _Wissenschaftslehre_ is concerned with how we know things about the world.  Fichte's describes it as an investigation into resolving the contradictions contained in the founding principle of theoretical philosophy, which we can simply refer to as the _Theoretical Principle_:
...
Fichte's goal is this section is to figure out how the _Theoretical Principle_ is possible.  We can roughly divide the phases of Fichte's investigation into three stages:
1.  In a first stage, Fichte introduces a series of six concepts that he believes are essential to explain the _Theoretical Principle_.
2.  In the second stage, Fichte uses these six concepts to map out various accounts of the _Theoretical Principle_.  These accounts are all versions of _realism_ or _idealism_.
3.  At the conclusion of the second stage, Fichte puts forth a new account that is entirely different in character from the _idealist_ nor _realist_ accounts he has thus far set up. Whereas the previous accounts are all dualist in that they assume a Self and a Not-Self as their starting point, this account is monist, since it takes the Self to be the starting point, and then describes how, a Not-Self emerges from the Self.  This is Fichte's so-caled 'theory of the _check_' (Anstosslehre), and the remainder of the _Theoretical Part_ is devoted to fleshing out this account.

(Note that this three stage division is an artificial construct that is not delineated in the actual text, but that we have introduced for explanatory purposes.)

The guiding thread throughout all three stages of the _Theoretical Part_ are six guiding concepts that Fichte employs in a highly structured manner that we can map out as follows:
@@SVG3@@
We can overlay the three stages idenitfied above on this roadmap as follows:
@@SVG3@@

This diagram is to be read from top to bottom, and then, approximately, from left to right.  In stage 1, Fichte is introducing his six concepts and explaining how these concepts combine so as to isolate eight different aspects of the _Theoretical Principle_.  In stage two, Fichte is showing how these six concepts, or eight aspects work together to form incomplete accounts of the _Theoretical Principle_.  In stage 3, we then get the complete, or the monist theory of the check.
...
* _Causality_ says that the Self and the Non-Self stand in a relationship of efficient causality to one another.  Since all positing, according to Fichte's _First Principle_ (or also the _Third Principle_), starts from the Self, the Non-Self only has reality for the Self insofar as the Self posits it.  The question is thus the following: what is causing, or _affecting_, the Self to posit the Non-Self, to endow it with reality, or, as Fichte also formulates it, trasfer activity to the Non-Self? The concept of causality leaves this question open, but limits the answer to two possibilities:
    1. The Self is intiating the action of the _Theoretical Principle_, affecting itself such that it posits the Non-Self.
    2. The Non-Self is initiating the of the _Theoeretical Principle_, affecting the Self, and therefore causing the Self to undergo its positing of the Non-Self.
* _Substance_ says that Self is a substance and the Non-Self is an accident of the Self (not an _accident_ in the sense of a _mistake_, but rather in the formal philosophical sense that green is an accident of the substance tree, for example).  The notion of the Self as a substance follows more or less from the _First_ and _Third Principles_, which says that all positing is done by the Self.  Therefore Fichte can say that the Self contains the set of 'all realities'. The Non-Self is then a subset of that complete set of all realities.
