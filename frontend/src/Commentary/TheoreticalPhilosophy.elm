...
## The argument of the _Theoretical Part_

We can understand the _Theoretical Part_ as an extended argument against Kantian dualism for a specific type of monism that we can call a dual-aspect monism.  In the course of the _Theoretical Part_ Fichte considers a variety of explanations for how mind and world interact before settling on his preferred account.  In the final account, the world is subsumed within the mind, but reemerges as the realist _aspect_ of conscious experience.  Conscious experience, according to this final acccount, is not possible without both the realist aspect of a causally determined world and the idealist aspect of an awareness that brings conceptual order to such a world.  Neither aspect can exist without the other.   

Arriving at this account is the same as figuring out how the _Theoretical Principle_ is possible, and that means resolving its central contradiction.  On the one hand, the Non-Self is determining the Self.  On the other, the Self is _taking itself_ to be determined, and this act of _taking onself_ to be something is also a kind of determination.  Thus, determination flows in two contradictory directions.  The Non-Self _determines_ the Self.  However it is also true that the Self is _determining_ this determination of the Self by the Non-Self. So which of the two entities is ultimately determining the other?

Fichte takes this contradiction to be his formulation of the contradiction between realism and idealism.  A realist would say that the Non-Self is ultimately the cause of the Self taking itself to be determined by the Non-Self.  An idealist would argue that in fact the Self is determining or causing the determination, or limitation, that the Non-Self appears to be imposing on the Self.  In this latter case, the _Theoretical Principle_ is a case of Self-determination, in the former, the Self is being determined by something outside itself, namely the Non-Self.  The goal of the _Theoretical Part_ is to come to an understanding of realism and idealism that sees them not as standing in contradiciton to one another, but rather as two complementary aspects of the single act of theoretical knowledge.


## The different stages of _The Theoretical Part_

In order to resolve this contradiciton between realism and idealism, Fichte uses a two-step procedure consisting of an analytical phase followed by a synthetic phase.  In the analytic phase, Fichte distinguishes between the idealist and realist aspects at work in the interaction between Self and Non-Self.  In the synthetic phase, Fichte plays out the aspects out against each other, considering first the idealist scenario in which the idealist aspect explains, or forms the ground of, the realist aspect, and then considering the realist scenario in which the opposite is the case. Then, to conclude the synthetic phase, Fichte considers the third possibility in which the idealist and realist aspects mutually determine one another.  It is always this third scenario of mutual determination that moves Fichte closer to the account he holds to be correct.  With each successive synthesis, new details emerge about his account until finally culminating in the theory of the check.
...
Fichte identifies a total of three different pairs of complementary concepts that he believes come to bear on _Theoretical Principle_.  In addition to the distinction between form and matter, Fichte singles out the distinction between causality and substance as one such pairing, and also the distinction between what we can call first-person and third-person interaction.  These three analyses do not occur separately, but are rather additive, in the sense that every side of each analysis combines all the other concepts of the other analyses. What this means concretely is that Fichte begins by distinguishing between causal interaction and substantial interaction, the former which leads to a realist understanding of the _Theoretical Principle_, the latter to an idealist understanding.  Having made that distinction, he then further distinguishes between two types of causal interaction, and two types of substantial interaction.  Causal interaction can be applied to first-person interaction, in which case the Self is observing its own causal interaction, as well as to third-person interaction, in which case the Self is an onlooker to interacting objects.  In the former case, we are making an idealist assumption that the Self is directly engaged in all manner of interaction, and in the latter case we make a realist assumption as we examine objects interacting independently of the Self's positings. The same holds true for substantial interaction.  When the Self is engaged in a substantial interaction with the Non-Self, we are in the realm of first-person interaction and are taking an idealist view of things.  When we abstract from the first-person perspective of the Self and observe how objects, independent of the Self engage in substantial interaction, we are viewing things as a realist would.  Finally, each of these four types of interactions divides into their formal and material aspects, so that we end up with a total of four separate distinctions between form and matter: @@Image@@

The analysis that we handled in the previous section is thus in fact the analysis of form and matter under the concept of first-person causal interaction.  As can be seen from that example, it is always the most immediate analysis, so in this case the form-matter distinction that determines if we are dealing with an idealist or a realist view of things.

Just as the analyses are cumulative, so are the syntheses.  The synthesis stage consists in cumulatively synthesizing each finer analysis into a synthesis, and then synthesizing those syntheses into larger syntheses.  So, for example, the form and matter or causal first-person interaction are synthesized. Then the form and matter of causal third-person interaction are synthesized. Then, the synthesized notion of first-person causal interaction is synthesized with the synthesized notion of third-person causal interaction.  Interestingly, Fichte does not provide a final synthesis of causal and substantial interaction, and one can speculate on whether this is an oversight on his part, or if he perhaps has a good reason for doing so. Regardless of this open question, we can observe the clear tendency of these successive analyses and syntheses.  With each analyses, Fichte is able to isolate a separate aspect of his _Theoretical Principle_, and with each synthesis, he is able to move toward the account of theoretical philosophy that he holds to be valid.

## The significance of the system of analyses and syntheses

Before looking at each analysis and synthesis in more detail, it is helpful to consider the larger significance of this particular arrangement of analyses and syntheses that Fichte chooses.  Nowhere else in his writings does Fichte proceed in such an ordered fashion.  His strict adherence here to the three pairs of complementary concepts is reminiscent of Kant's strict orientation around the table of categories in the _Critique of Pure Reason_.  There can be no doubt that Fichte considers these six concepts to be the cornerstones of his theoretical philosophy.  He spends considerable time drawing out these distinctions, and then, in the course his syntheses, transforming our understanding of them in order to unfold the monist philosophy that he ultimately wants to advance. We can therefore understand the overall tendency of the _Theoretical Part_ by summarizing how Fichte first introduces each of these six concepts and how our understanding of them morphes in the course of the various synthses.
...
* Substance: The concept of substance is the most important of the six concepts, and the keystone of Fichte's monism. Fichte defines a substance as 'something that is all encompassing' and applies the concept to the Self as follows:
~~~The Self is a substance, in so far as we view it as encompassing the entire, absolutely determined ambit of all realities.~~~
This conception of the Self as substance holds onto the idea from the _First Principle_ that all positing is done by the Self, and therefore everything posited must be posited by the Self.  The Self 'encompasses' all of its reality because it is the thing that posits this reality.  In the _Theoretical Part_, the challenge for this conception of the Self as substance is to explain how and why the Self posits a Non-Self.  If the Self encompasses all of its reality, then one might think that there is no place for the Non-Self, for all reality is, by definition, a product of the Self.  Fichte answers this challenge with the monist account he wants to advance.  The Self posits a Non-Self because it encounters 'resistance' in the course of its activity. In answer to the second question, the question of how the Self holds onto the otherness, the Non-Selfness, of this reality it has encountered, Fichte advances his account of the imagination.  We will look at this account more closely later on, but we can say now that, according to Fichte, the imagination is the human capacity to hold onto a contradiction, to posit both p and Not-p.  When considering the concept of substance, the notion of the Non-Self provokes such a contradiction - it must be attributable to both the Self, and a Non-Self.  According to Fichte, the imagination allows for this to happen, i.e. for the Self to consider the Non-Self as both a product of the Self, and not a product of the Self. The Non-Self exists within the Self as something that the Self posits, but the imagination endows, or reifies, the Non-Self with a second, contradictory quality of otherness, such that the Non-Self appears to the Self as a second entity that is determining the Self. This quality of otherness manifests itself as the indeterminateness of the objective world.  Whereas the Self is determined for itself, i.e. the Self can always identitfy, or point to itself, the entities of objective world are first undetermined for the Self and have to gain their determinateness through the experience of the Non-Self, or the acquisition of theoretical knowledge.

The next pair of distinctions, _third-person interaction_ versus _first-person interaction_, concerns the two different ways in which the Self can experience the substantial and causal cases of interaction defined in the prior pair of distinctions.  In the third-person case, the Self is considered a non-participating observer of the interaction in question.  In the case of causal interaction, this would apply to any case in which the Self is observing how one object, say a hammer, is causally acting on another object, such as a nail.  In the case of substantial interaction, the Self observes how two contradictory properties, or accidents, apply to an object, or substance.  Substantial interaction occurs when a property that applies in one instant, no longer applies in the next instant.  Fichte's favorite example here is of a piece of iron which is stationary in one moment, and then in the next moment, in the presence of a magnet, is in motion.  In both causal and substantial third-person interaction, the act of observing an interaction is, of course, the act of _positing_ the interaction, since, according to the first principle, all cases of knowledge, even so-called 'passive' observations, are only observations in so far as the Self posits them.  Fichte's aim in the syntheses of third-person interaction is to understand how causality and substance work in the empirical world, i.e. how the Self applies the concepts of causality and substance, generally speaking.  Only in the syntheses of first-person interaction does the complicating fact come into view that the Self is in fact one of the parties to the causal and substantial interactions.

The conclusions that Fichte draws in the cases of causal and substantial third-person interaction are more or less the same and can be summarized in terms of a dynamization of the world.  In these syntheses, Fichte works to undermine our impression that the world is a stable collection of objects that only occasionally interact.  Fichte wants to show us that in fact the objects of the world are in a constant state of flux, constantly annihilating one another, constantly given rise to new states.  The mind gets a grip on this continuous flux by suspending, or holding apart, the conflicting objects within the matrix and space and time.  The understanding abstracts away from small interactions, and while the imagination slows down larger interactions by expanding their temporal-spatial realm so that they take more time to come into contact with one another and interact.

The causal and substantial syntheses of third-person interaction have nothing _directly_ to say about the idealism or realism of the _Theoretical Principle_. This is because in the _Theoretical Principle_ the Self is part of the interaction itself, and therefore doesn't have the luxury of adopting an exlusively third-person perspective on its interaction with the Non-Self.  Nevertheless, the third-person syntheses are crucial to challenging the dualist assumption upon which the _Theoretical Principle_ is based.  The syntheses replace our implicit understanding of the Self and Non-Self as stable entities with an understanding of Self and Non-Self as emergent entities that coalesce in order to explain the Self's experience of resistance that occurs in response to its constant activity.

In constrast to third-person interaction, the syntheses of first-person interaction are directly concerned the realist versus idealist understandings of the _Theoretical Principle_.
  * Within the syntheses, Fichte works to resolve realism and idealism with the help of the form matter distinction, as in the example above.
  * Then, we the synthesized notion of first-person interaction is pitted against third-person interaction, in again represents the idealist side of the equation.  Explain this.  Fichte's word choice is relevant here, as well as the larger claim that what is really at stake in this distinction is the distinction between being and thinking. 





Understood causally, the _Theoretical Principle_ describes the Self as the object being causally acted upon. In the case of substance, the _Theoretical the Self is the substance to which the ascriptions, or accidents, of Self and Non-Self apply.  In both of thee cases, the Self is experiencing the causal or substantial change directly as the bearer of this change.  This is why the other side of this 

Taking to be a case of causal interaction, the _Theoretical Principle_ describes a case In the case of causal when the Self is involved the Fichte is interested 


 Fichte's example for substantial interaction con   Fichte's example of this is the interaction between a magnet and an a piece of iron.  can manifest themselves in the world.  In the case of _empirical interaction, w   interaction_ and _transcendental interaction_ concerns  

* Mere interaction: According to Fichte's starting point in the _Theoretical Part_, the _Theoretical Principle_ defines an interaction between two entities, the Self, and the Non-Self.  Fichte further  specifies his conception of interaction by describing it as an 'exchange between activity and passivity', or simply _exchange_.  For the concept of causality, this means that the activity of one entity corresponds exactly to the passivity, or suffering of a second entity.  Applied to the concept of causality, the determining, active entity is the cause, and the passive, suffering entity that is being determined is the effect.  In the case of substance, an exchange occurs when an accident that was taken to apply to a substance, and that is in this sense active, is supplanted by another, contradictory accident. Here, the activity of the usurping accident corresponds to the passivity, or suffering of the accident that is usurped.  We can call these two types interaction _empirical_ interaction, because they abstract from the fact that the 

*Conscious interaction: 

they apply as much to empirical objects as they do the transcendental entities of the Self and the Non-Self.  As Fichte says Furthermore, when they are applied to the Self and the Non-Self, Fichte deems them to be deficient, saying that they cannot explain the specific cognitive achievement that the _Theoretical Principle_ describes.  In the case of causality, this is because the entity that is acted upon need not be an entity that has awareness.  It could as much be a rock or the table that is being causally determined by a hammer, say.  


In contrast to causality, Fichte always ties the exchange of substance to the cognitive of taking an accident to be the case.  Fichte calls this cognitive act the act of positing an accident 'absolutely' or 'unconditionally'.  In so far as the Self posits itself absolutely, then the emp   





the determining Non-Self corresponds exactly to a passivity in the Self.  The Self is passive to the exact extent that the Non-Self is active.  The concept of substance operates slightly differently with this concept: the Self's claim to totality suffers, or is passively acted upon, to the extent that the Self posits a Non-Self.  Here, the active side of the equation of the Self's positing of the Non-Self, and the passive side is the Self's claim to being the totality of all that is posited.  In so far as the Self posits a Non-Self, its totality suffers.  As becomes clear, in the course of describing and It might at first appear that Fichte is defining 

* Transcendnetal Interaction:


he the Non-Self is simple the Self might simply be the Self  all of this reality, .  Substantial interaction must answer It also captures the fact that the Self is the grammatical subject of the _Theoretical Principle_. Nothing other than the Self itself can set the Self 'as determined by the Non-Self', for only the Self has the ability to 'set', or 'posit' in the first place.  

The synthesis of Substantial interaction, however, has to 
In the analyses and syntehses and substantial interaction, Fichte addresss The issue that Fichte deals with in the analyses and The problem with the concept of substance, as Fichte sees it, is that it leaves both the concept of determination and the concept of the Non-Self problmenatic.   If all reality belongs to the Self, then the Non-Self is not really a Non-Self at all, but rather just an accident of the Self.  Similarly, why should the Self, which as substance is absolute, put any limitation on itself in the first place?

 Within the the _Theoretical Philosophy_, it
