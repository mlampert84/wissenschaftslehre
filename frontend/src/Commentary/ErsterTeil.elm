...
The uniqueness of Fichte's entire philosophy turns on this need to identify the common ground between the Self and the Non-Self. It is what makes Fichte's philosophy monist and not dualist.  Kant, for example, delivers a dualist system, consisting of a fundamental difference between the transcendental Self and the thing-in-itself.  Spinoza, a monist, argues that the thoughts and actions of people are modifications of one all-encompassing substance.  Described in terms of Fichte's system, Spinoza finds the common ground of the Self and the Non-Self to reside in the Non-Self, of which the Self is a small part or modification.
